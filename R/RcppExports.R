...
#' @keywords internal
#' 
.allTuplesSorted <- function(pos1, internal_pos, posm) {
...
.compareGTuplesCpp <- function(int_seqnames, int_strand, int_pos) {
    .Call('GenomicTuples_compareGTuplesCpp', PACKAGE = 'GenomicTuples', int_seqnames, int_strand, int_pos)
}
...
.IPD <- function(pos1, internal_pos, posm) {
